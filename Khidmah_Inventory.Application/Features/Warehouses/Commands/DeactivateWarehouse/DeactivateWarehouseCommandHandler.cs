...
public class DeactivateWarehouseCommandHandler : IRequestHandler<DeactivateWarehouseCommand, Result<WarehouseDto>>
{
    ...
    public async Task<Result<WarehouseDto>> Handle(DeactivateWarehouseCommand request, CancellationToken cancellationToken)
    {
        ...
        warehouse.Deactivate(_currentUser.UserId);
