...
public class DeactivateSupplierCommandHandler : IRequestHandler<DeactivateSupplierCommand, Result<SupplierDto>>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUserService _currentUser;

    public DeactivateSupplierCommandHandler(IApplicationDbContext context, ICurrentUserService currentUser)
    {
        _context = context;
    ...
    public async Task<Result<SupplierDto>> Handle(DeactivateSupplierCommand request, CancellationToken cancellationToken)
    {
        ...
        supplier.Deactivate(_currentUser.UserId);
