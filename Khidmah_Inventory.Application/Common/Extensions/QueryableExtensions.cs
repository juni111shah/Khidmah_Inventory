...
namespace Khidmah_Inventory.Application.Common.Extensions;
...
public static class QueryableExtensions
{
    ...
    /// </summary>
    public static IQueryable<T> ApplyFilters<T>(this IQueryable<T> query, List<FilterDto>? filters)
    {
        return ApplyFiltering(query, filters);
    }
    ...
    /// </summary>
    public static IQueryable<T> ApplySearch<T>(this IQueryable<T> query, string searchTerm, List<string> searchFields, SearchMode mode = SearchMode.Contains, bool isCaseSensitive = false)
    {
        ...
        return ApplySearch(query, searchRequest);
    }
