    ...
    public partial class makeDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SettingsType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DimensionsUnit = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomReports_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bins_WarehouseZones_WarehouseZoneId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WarehouseId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SerialNumberValue = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    WarrantyExpiryDate = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    IsRecalled = table.Column<bool>(type: "bit", nullable: false),
                    RecallDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RecallReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SerialNumbers_SalesOrderItems_SalesOrderItemId",
                        column: x => x.SalesOrderItemId,
                        principalTable: "SalesOrderItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SerialNumbers_SalesOrders_SalesOrderId",
                        column: x => x.SalesOrderId,
                        principalTable: "SalesOrders",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_CompanyId_CreatedAt",
                table: "ActivityLogs",
                columns: new[] { "CompanyId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_CompanyId_EntityType_EntityId",
                table: "ActivityLogs",
                columns: new[] { "CompanyId", "EntityType", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_CompanyId_UserId",
                table: "ActivityLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Batches_CompanyId_ExpiryDate",
                table: "Batches",
                columns: new[] { "CompanyId", "ExpiryDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Batches_CompanyId_IsRecalled",
                table: "Batches",
                columns: new[] { "CompanyId", "IsRecalled" });

            migrationBuilder.CreateIndex(
                name: "IX_Batches_CompanyId_ProductId_BatchNumber",
                table: "Batches",
                columns: new[] { "CompanyId", "ProductId", "BatchNumber" },
                unique: true,
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_CompanyId_CreatedAt",
                table: "Comments",
                columns: new[] { "CompanyId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Comments_CompanyId_EntityType_EntityId",
                table: "Comments",
                columns: new[] { "CompanyId", "EntityType", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_Comments_CompanyId_ParentCommentId",
                table: "Comments",
                columns: new[] { "CompanyId", "ParentCommentId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomReports_CompanyId_CreatedByUserId",
                table: "CustomReports",
                columns: new[] { "CompanyId", "CreatedByUserId" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomReports_CompanyId_ReportType",
                table: "CustomReports",
                columns: new[] { "CompanyId", "ReportType" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomReports_CreatedByUserId",
                table: "CustomReports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SerialNumbers_CompanyId_BatchId",
                table: "SerialNumbers",
                columns: new[] { "CompanyId", "BatchId" });

            migrationBuilder.CreateIndex(
                name: "IX_SerialNumbers_CompanyId_CustomerId",
                table: "SerialNumbers",
                columns: new[] { "CompanyId", "CustomerId" });

            migrationBuilder.CreateIndex(
                name: "IX_SerialNumbers_CompanyId_ExpiryDate",
                table: "SerialNumbers",
                columns: new[] { "CompanyId", "ExpiryDate" });

            migrationBuilder.CreateIndex(
                name: "IX_SerialNumbers_CompanyId_IsRecalled",
                table: "SerialNumbers",
                columns: new[] { "CompanyId", "IsRecalled" });

            migrationBuilder.CreateIndex(
                name: "IX_SerialNumbers_CompanyId_ProductId_Status",
                table: "SerialNumbers",
                columns: new[] { "CompanyId", "ProductId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_SerialNumbers_CompanyId_SerialNumberValue",
                table: "SerialNumbers",
                columns: new[] { "CompanyId", "SerialNumberValue" },
                unique: true,
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SerialNumbers_SalesOrderId",
                table: "SerialNumbers",
                column: "SalesOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_SerialNumbers_SalesOrderItemId",
                table: "SerialNumbers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Settings_CompanyId_SettingsType_SettingsKey",
                table: "Settings",
                columns: new[] { "CompanyId", "SettingsType", "SettingsKey" },
                unique: true,
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_StockLevels_CompanyId",
                table: "StockLevels",
                column: "CompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowHistory_CompanyId_CreatedAt",
                table: "WorkflowHistory",
                columns: new[] { "CompanyId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowHistory_CompanyId_WorkflowInstanceId",
                table: "WorkflowHistory",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowInstances_CompanyId_CurrentAssigneeId",
                table: "WorkflowInstances",
                columns: new[] { "CompanyId", "CurrentAssigneeId" });

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowInstances_CompanyId_EntityType_EntityId",
                table: "WorkflowInstances",
                columns: new[] { "CompanyId", "EntityType", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowInstances_CompanyId_Status",
                table: "WorkflowInstances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workflows_CompanyId_EntityType_IsActive",
                table: "Workflows",
